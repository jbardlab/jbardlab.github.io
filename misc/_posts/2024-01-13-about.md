...
<a name="join"></a>
# Join
We are always looking for new members to join our team. If you are interested in joining the lab, please send a description of your research interests, names and contacts for two references and a CV.
...
This site was built directly from [Trevor Bedford]'s beautiful [site](http://bedford.io), with further modifications based on those done by [Allan Drummond](http://drummondlab.org/team/allan-drummond/) for the Drummond Lab [website](http://drummondlab.org). 
...
The site's source code is freely available on [GitHub](https://github.com/jbardlab/jbardlab.github.io). All code is placed under the MIT license. You're welcome to borrow / repurpose code to build your own site, and if you do, I'd appreciate attribution and a link back to Trevor's original [site](http://bedford.io) and [here](http://bardlab.org/about.html).
